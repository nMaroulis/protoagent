...
| Documentation site | `protoagent-docs` | `0.2.3` | Active release metadata | `docs/package.json` |

“ProtoAgent 0.2.3” is the coordinated release train for the active CLI and core
...
1. Confirm required ProtoLink release `0.7.1` is available from the target
   package index. Publish ProtoLink first; ProtoAgent 0.2.3 cannot install from
